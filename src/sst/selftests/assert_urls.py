...
sst.actions.assert_url_contains('http://localhost:%s/begin' % DEVSERVER_PORT)
sst.actions.assert_url_contains('localhost:%s' % DEVSERVER_PORT)
...
sst.actions.assert_url_network_location('localhost:%s' % DEVSERVER_PORT)
